...
= \sum_{t=i}^T \frac{\partial L}{\partial h_t}\frac{\partial h_t}{\partial h_{t-1}}
    \cdots\frac{\partial h_i}{\partial x_i}.
$$
Let's try writing out this out for a couple steps:
$$
\begin{array}{ccccc}
...
\end{array}
$$
This seems like a relatively simple combination of a cumulative product,
$$\prod_{t=i}^T \frac{\partial h_{t+1}}{\partial h_t}$$,
and sum of terms taken from that product.
