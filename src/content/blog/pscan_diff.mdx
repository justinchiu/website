...
# Parallel scans
Say we have a sequence of inputs, $$x_1, x_2,\ldots,x_5$$, which can be vectors, matrices, etc.
...
Actually...this is already a parallel scan ($$\otimes,\oplus$$). Need to rewrite this conclusion XD.

# Grid form
Let's trek all the way back to equation (3),
$$
\frac{\partial L}{\partial x_i}
= \sum_{t=i}^T \frac{\partial L}{\partial h_t}\frac{\partial h_t}{\partial h_{t-1}}
    \cdots\frac{\partial h_i}{\partial x_i},
...
# More efficient?
Next question: can the backward pass be written as a single parallel scan,
rather than two?
Also, if anyone knows how to make katex arrays look better.
