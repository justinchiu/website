...
3. Reward $r(x)$: In the SFT setting, the teacher examples are assumed to have reward $r(x)=1$. This doesn't make sense if you actually have a reward function and the teacher examples do not have reward 1.
