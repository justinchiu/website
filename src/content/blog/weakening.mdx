...
- In realistic MoE architectures, the sum over experts is expensive or intractable, so it is natural to approximate it by Monte Carlo over routes; as we discuss in Section 4, this introduces a **nested Monte Carlo estimator** with poor bias–variance behaviour.
...
### 4.1 Generic background: nested estimators
