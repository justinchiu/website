...
They describe the unobserved processes that generate data.
While they are rarely the key to making things work, they provide a pretty universal thought framework for formalizing things.
This makes talking about a wide variety of things really easy! [^examples]
Unfortunately, that's kind of where the usefulness of LVMs ended in the past.
In reality, LVMs are really computationally intensive to train.
...
TODO say that LVMs are going to be even more important now though with LLMs?

Let's start with an example. TODO


In this post we will introduce the math of LVMs, how to train them, and derive variational autoencoders from scratch as a way to reason about approximation tradeoffs along the way.
This post is longer than usual and aims to help you reason through the problem solving process of amortized variational inference.
...
# Good expectations
TODO: Section on what makes something easy to approximate.

# Gradient estimation attempt 1: Brute force
...
# Gradient estimation with help from sir VAE
